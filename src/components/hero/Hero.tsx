...
export default function Hero() {
  ...
  return (
    <section className="relative pt-6 pb-16 text-gray-900 overflow-hidden"> 
      {/* CONTAINER with gradient background */}
      <div className="px-10 md:px-16 lg:px-24">
        <div className="bg-gradient-to-r from-green-100 to-green-200 rounded-2xl shadow-lg">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 items-center gap-8 py-12 px-10 lg:px-12">
            {/* LEFT - text + search + status */}
