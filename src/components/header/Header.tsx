...
const Header: React.FC = () => (
  <header className="flex items-center px-4 py-3 bg-white shadow-sm relative">

    {/* LEFT – 5 % OFF  (pushed a bit to the right) */}
    ...
    {/* CENTER – LOCATION  (absolute centre of header) */}
    <div className="absolute left-1/2 -translate-x-1/2">
      <Location />
    </div>

    {/* RIGHT – exact look from the image: 23Items + GBP79.89 */}
